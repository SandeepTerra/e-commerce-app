...
namespace e_commerce_app.Controllers
{
    public class ShopController : Controller
    {
        ...
        public ShopController(ICommerceRepo commerceRepo, IConfiguration configuration,
        ...
        {
            var products = _commerceRepo.GetProducts().Result.AsQueryable();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var foundProduct = await _commerceRepo.GetProductById(id);
        ...
        public async Task<IActionResult> Add(int? id)
        {
            ...
            Product product = _commerceRepo.GetProductById(id).Result;
